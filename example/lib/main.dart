...
import 'package:hydrogenpay_flutter_webview/new/customization.dart';
import 'package:hydrogenpay_flutter_webview/new/methods.dart';
import 'package:hydrogenpay_flutter_webview/new/payload.dart';
...
class PaymentTest extends StatelessWidget {
  ...
  paymentStart(context) {
    PayloadModel payload = PayloadModel(
      ...
      mode: "TEST",
      token: "E2E411B102072296C73F76339497FB8529FF552F0D6817E0F3B46A243961CA21"
    );
